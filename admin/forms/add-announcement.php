...
if (isset($_POST['save'])) {
    ...
    if (empty($errors)) {
        if ($announcement->add()) {
            ...
            $errors['db'] = "An error occurred while adding the announcement in the database.";
        }
    }
}
?>
                ...
                <div class="modal-body mt-2">
                    ...
                    <form method="post" action="">
                        <div class="row d-flex justify-content-center my-1">
                            <div class="input-group flex-column mb-3">
                                ...
                                <input type="text" name="eaTitle" id="eaTitle" class="input-1"
                                       ...
                                       value="<?= htmlspecialchars($_POST['eaTitle'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex justify-content-center my-1">
                            <div class="input-group flex-column mb-3">
                                ...
                                <input type="text" id="eaDescription" name="eaDescription"
                                       ...
                                       value="<?= htmlspecialchars($_POST['eaDescription'] ?? '') ?>"
                        ...
                        <div class="modal-action-btn d-flex justify-content-end">
                            ...
                            <button type="submit" name="save" class="btn request-btn-2 mb-3 me-4">Done</button>
                        </div>
                    </form>
                </div>
            </div>
