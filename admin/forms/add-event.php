...
function selectedIf($value) {
    return (isset($_POST['eventCity']) && $_POST['eventCity'] == $value) ? 'selected' : '';
}
                        ...
                        <div class="row d-flex justify-content-center mt-1">
                            ...
                            <div class="input-group flex-column mb-3">
                                ...
                                <select name="eventRegion" id="eventRegion" class="input-1">
                                    ...
                                    <option value="Region IV-A" <?php if(isset($_POST['eventRegion']) && $_POST['eventRegion'] == 'Region IV-A') { echo 'selected'; } ?>>Region IV-A</option>
                                    <option value="Region IV-B" <?php if(isset($_POST['eventRegion']) && $_POST['eventRegion'] == 'Region IV-B') { echo 'selected'; } ?>>Region IV-B</option>
                            ...
                            <select name="eventCity" id="eventCity" class="input-1" required>
                                ...
                                foreach ($cities as $city) {
                                    $selected = (isset($_POST['eventCity']) && $_POST['eventCity'] == $city) ? 'selected' : '';
                        ...
                        <div class="input-group flex-column mb-3">
                            ...
                            <select name="eventBarangay" id="eventBarangay" class="input-1" required>
                                ...
                                if(isset($_POST['eventCity'])) {
                                    // This would be populated by JavaScript, but we include a PHP fallback
                                    $barangays = []; // This would be populated from your database
                                    foreach ($barangays as $barangay) {
                                        $selected = (isset($_POST['eventBarangay']) && $_POST['eventBarangay'] == $barangay) ? 'selected' : '';
                    ...
                    $(document).ready(function() {
                        ...
                        $('#eventRegion').change(function() {
                            ...
                            if (provinces.length > 0) {
                                ...
                                $('#eventCity').empty().append($('<option>', { value: '', text: 'Select City' })).prop('disabled', true);
                                $('#eventBarangay').empty().append($('<option>', { value: '', text: 'Select Barangay' })).prop('disabled', true);
                            } else {
                                $('#eventProvince').prop('disabled', true);
                                $('#eventCity').prop('disabled', true);
                                $('#eventBarangay').prop('disabled', true);
                        ...
                        $('#eventProvince').change(function() {
                            ...
                            $('#eventCity').empty().append($('<option>', { value: '', text: 'Select City' }));
                        ...
                        $('#eventCity').change(function() {
                            ...
                            $('#eventBarangay').empty().append($('<option>', { value: '', text: 'Select Barangay' }));
