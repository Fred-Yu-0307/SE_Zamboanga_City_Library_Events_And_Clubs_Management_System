                ...
                <div class="container mt-4">
                    ...
                    <form method="post" action="" id="addClubForm" onsubmit="return validateForm()">
                        ...
                        <div class="row d-flex justify-content-center my-1">
                            <div class="input-group flex-column mb-3">
                                ...
                                <textarea id="clubDescription" name="clubDescription" 
                                        class="input-1 auto-expand-textbox" 
                                        placeholder="Write brief description" 
                                        required
                                        data-min-rows="2" 
                                        data-max-rows="6"
                                        style="min-height: 60px; max-height: 180px; overflow-y: auto"><?php 
                                    if(isset($_POST['clubDescription'])) { 
                                        echo htmlspecialchars($_POST['clubDescription']); 
                                    } 
                                ?></textarea>
                        ...
                        <div class="modal-action-btn d-flex justify-content-end">
                            <a type="button" class="btn cancel-btn mb-4 me-4" onclick="window.history.back();" aria-label="Close">Cancel</a>
